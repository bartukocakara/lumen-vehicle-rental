    ...
    */
    ...
    'custom' => [
        'paymentCard.cardNumber' => [
            'required' => 'Kart Numarası alanının doldurulması zorunludur',
        ],
        'paymentCard.expireYear' => [
            'required' => 'Kart Sona Erme Yılı alanının doldurulması zorunludur',
        ],
        'paymentCard.expireMonth' => [
            'required' => 'Kart Sona Erme Ayı alanının doldurulması zorunludur',
        ],
        'installment' => [
            'required' => 'Taksit alanının doldurulması zorunludur',
        ],
    ],
